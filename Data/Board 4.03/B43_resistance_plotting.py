# -*- coding: utf-8 -*-
"""
Created on Fri Jun 27 10:43:26 2025
...
folder_path = r"C:\Users\trott\Documents\Dataset-11-rectangular-electronic-SMD-assembly-under-repeated-5-kg-impacts\Data\Board 4.03"
save_path = r"C:\Users\trott\Documents\Dataset-11-rectangular-electronic-SMD-assembly-under-repeated-5-kg-impacts\Data\Board 4.03\Figures"
...
plt.grid(True)
plt.tight_layout()
plt.savefig(f"{save_path}\\4_3_metric_plot.png", dpi=300)
plt.show()