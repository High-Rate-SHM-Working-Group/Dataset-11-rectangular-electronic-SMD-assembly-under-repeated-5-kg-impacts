...
plt.grid(True)
plt.tight_layout()
plt.savefig(f"{save_path}\\all_boards_metric_plot_percent_based_with_trendlines_V211.png", dpi=300)
plt.show()
...
plt.grid(True)
plt.tight_layout()
plt.savefig(f"{save_path}\\all_boards_trendline_plot_V211.png", dpi=300)
plt.show()
...
for i in range(len(board_names)):
    ...
    plt.grid(True)
    plt.tight_layout()
    plt.savefig(f"{board_save_paths[i]}\\{board_names[i]}_metric_plot_percent_based_V211.png", dpi=300)
    plt.show()
