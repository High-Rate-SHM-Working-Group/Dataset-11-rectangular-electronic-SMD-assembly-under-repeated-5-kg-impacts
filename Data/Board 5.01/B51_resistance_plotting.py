...
folder_path = r"C:\Users\trott\Documents\Dataset-11-rectangular-electronic-SMD-assembly-under-repeated-5-kg-impacts\Data\Board 5.01"
save_path = r"C:\Users\trott\Documents\Dataset-11-rectangular-electronic-SMD-assembly-under-repeated-5-kg-impacts\Data\Board 5.01\Figures"
...
plt.grid(True)
plt.tight_layout()
plt.savefig(f"{save_path}\\5_1_metric_plot.png", dpi=300)
plt.show()